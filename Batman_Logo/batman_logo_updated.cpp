...
void full_black_box(int x, int y, int w, int h){
    glColor3f (0.0, 0.0, 0.0);
    glBegin(GL_QUADS);
...
void myDisplay(void){
    ...
    full_black_box(20, 100, 1, 7);
    full_yellow_box(30, 100, 1, 7);

    full_black_box(320, 100, 1, 7);
    full_yellow_box(310, 100, 1, 7);
    ...
    full_black_box(90, 230, 17, 1);
    full_yellow_box(90, 220, 17, 1);
    full_yellow_box(90, 210, 17, 1);

    full_black_box(90, 30, 17, 1);
    full_yellow_box(90, 40, 17, 1);
    full_yellow_box(90, 50, 17, 1);
